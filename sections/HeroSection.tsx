...
export default function HeroSection() {
  return (
    <section className="w-full px-8 py-24 md:py-32 border-b-4 border-[#1e1c12] bg-white relative overflow-hidden">
      ...
      {/* Available badge — absolute for lg+ */}
      <motion.div
        className="absolute top-10 right-10 border-4 border-[#1e1c12] bg-[#f4eddd] px-4 py-2 neo-shadow hidden lg:block"
        style={{ rotate: 3 }}
      ...
      <div className="max-w-4xl relative z-10">
        {/* Available badge — inline for md (tablet) only */}
        <motion.div
          className="hidden md:inline-flex lg:hidden border-4 border-[#1e1c12] bg-[#f4eddd] px-4 py-2 neo-shadow mb-6 items-center gap-2"
          style={{ rotate: -1 }}
